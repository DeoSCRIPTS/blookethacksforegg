/**
 * @author DeoSCRIPTS
 * @description A GUI for Blooket cheats that is easily expandable and customizable
 * @version 1.0.0
 * 
 * Best Blooket GUI out there, made with love by DeoSCRIPTS.
 */
...
(()=>{
    ...
    const cheat = (async () => {
        ...
        const guiWrapper = createElement(
            ...
            (variables = createElement("style", {
                id: "variables",
                innerHTML: `:root {
                    --backgroundColor: ${Settings.data?.theme?.backgroundColor || "linear-gradient(135deg, #667eea 0%, #764ba2 100%)"};
                    --infoColor: ${Settings.data?.theme?.infoColor || "rgba(106, 27, 154, 0.9)"};
                    --cheatList: ${Settings.data?.theme?.cheatList || "rgba(106, 27, 154, 0.75)"};
                    --defaultButton: ${Settings.data?.theme?.defaultButton || "rgba(138, 43, 226, 0.85)"};
                    --disabledButton: ${Settings.data?.theme?.disabledButton || "rgba(220, 38, 38, 0.85)"};
                    --enabledButton: ${Settings.data?.theme?.enabledButton || "rgba(34, 197, 94, 0.85)"};
                    --textColor: ${Settings.data?.theme?.textColor || "#ffffff"};
                    --inputColor: ${Settings.data?.theme?.inputColor || "rgba(139, 92, 246, 0.25)"};
                    --contentBackground: ${Settings.data?.theme?.contentBackground || "rgba(88, 28, 135, 0.35)"};
                }`,
            })),
            createElement("style", {
                innerHTML: `
                ...
                * {
                ...
                .cheatList::-webkit-scrollbar-thumb:hover {
                    background: rgba(255, 255, 255, 0.35);
                }
                
                .alertList, .contentWrapper {
                ...
                .scriptButton:hover {
                    ...
                    box-shadow: 0 10px 25px rgba(0, 0, 0, 0.35), inset 0 -6px rgba(0, 0, 0, 0.25);
                }
                ...
                .cheatInput::-webkit-inner-spin-button,
                .cheatInput::-webkit-outer-spin-button {
                ...
                .scriptButton {
                    ...
                    font-weight: 600;
                    color: var(--textColor);
                    box-shadow: 0 6px 18px rgba(0, 0, 0, 0.25), inset 0 -6px rgba(0, 0, 0, 0.2);
                    border-radius: 16px;
                    cursor: pointer;
                    transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1);
                    backdrop-filter: blur(10px);
            ...
            (gui = createElement(
                ...
                (controls = createElement("div", {
                    ...
                    style: {
                        ...
                        backdropFilter: "blur(20px)",
                        boxShadow: "0 4px 15px rgba(0, 0, 0, 0.25), inset 0 -1px rgba(255, 255, 255, 0.1)",
                ...
                (controlButtons = createElement(
                    ...
                    (dragButton = createElement("button", {
                        ...
                        innerHTML: "⊕",
                        onmouseenter: (e) => e.target.style.backgroundColor = "#0d8de0",
                        onmouseleave: (e) => e.target.style.backgroundColor = "#0ba5ff",
                    })),
                    createElement("button", {
                        ...
                        onclick: (function () {
                            ...
                            return () => {
                                ...
                                gui.style.height = hidden ? "100%" : "60px";
                                gui.style.width = hidden ? "100%" : "180px";
                                guiWrapper.style.top = `${parseInt(guiWrapper.style.top) + (guiWrapper.offsetHeight - 60) * (hidden ? -1 : 1)}px`;
                                guiWrapper.style.left = `${parseInt(guiWrapper.style.left) + (guiWrapper.offsetWidth - 180) * (hidden ? -1 : 1)}px`;
                ...
                (cheatContainer = createElement(
                    "div",
                    {
                        ...
                        style: {
                            ...
                            boxShadow: "inset -6px 0 20px rgba(0, 0, 0, 0.25)",
                            zIndex: "5",
                            width: "240px",
                            position: "absolute",
                            top: "0",
                        ...
                        innerHTML: '<span style="text-shadow: 2px 2px 8px rgba(0, 0, 0, 0.5); letter-spacing: 1px; font-weight: 900;">FRIXIUM</span>',
                    },
                    createElement("a", {
                        className: "bigButton",
                        style: {
                        ...
                        innerHTML: `<div style="background: rgba(0,0,0,.3); border-radius: 8px; display: block; width: 100%; height: 100%; left: 0; top: 0; position: absolute; transform: translateY(3px); transition: transform .4s cubic-bezier(.3,.7,.4,1)"></div>
            <div style="background-color: rgb(11, 194, 207); filter: brightness(.75); position: absolute; top: 0; left: 0; width: 100%; height: 100%; border-radius: 8px;"></div>
            <div style="font-weight: 600; background: linear-gradient(135deg, rgb(11, 194, 207), rgb(9, 169, 180)); color: white; display: flex; flex-direction: row; align-items: center; justify-content: center; text-align: center; padding: 8px; border-radius: 8px; transform: translateY(-4px); transition: transform .4s cubic-bezier(.3,.7,.4,1); box-shadow: 0 4px 12px rgba(11, 194, 207, 0.4);">
            <div style="font-family: 'Inter', sans-serif; color: white; font-size: 20px; text-shadow: 2px 2px rgba(0, 0, 0, 0.3); height: 44px; padding: 0 16px; display: flex; flex-direction: row; align-items: center; justify-content: center; font-weight: 700; gap: 8px;">
                <svg style="filter: drop-shadow(2px 2px 0 rgb(0 0 0 / 25%))" xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" viewBox="0 -1 21 16">
                        ...
                        (cheats = createElement(
                            "div",
                            {
                                style: {
                                    ...
                                    backdropFilter: "blur(15px)",
                                    boxShadow: "inset 0 -6px rgba(0, 0, 0, 0.2), 0 4px 15px rgba(0, 0, 0, 0.15)",
                                    borderRadius: "14px",
                            ...
                            (headerText = createElement(
                                "div",
                                {
                                    ...
                                    style: {
                                        ...
                                        boxShadow: "0 6px 15px rgba(0, 0, 0, 0.25), inset 0 -4px rgba(0, 0, 0, 0.2)",
                                        borderRadius: "12px",
                                    },
                                },
                                createElement("div", {
        ...
        function addMode(mode, img, cheats, nameOnly) {
            const button = createElement("div", {
                ...
                innerHTML: (typeof img == "string" ? `<img style="height: 32px; margin-right: 10px; filter: drop-shadow(0 2px 4px rgba(0,0,0,0.3));" src="${img}">` : img ? img : "") + mode,
                ...
                if (!element) {
                    const button = createElement(
                        "div",
                        {
                            ...
                            style: { 
                                background: toggle ? (enabled ? "var(--enabledButton)" : "var(--disabledButton)") : "var(--defaultButton)",
                    ...
                    if (inputs?.length)
                        for (let i = 0; i < inputs.length; i++) {
                            ...
                            if (type == "options" && options?.length) {
                                ...
                                input.placeholder = name;
                                input.style.textAlign = "center";
                                if (toggle) input.style.backgroundColor = "rgba(0, 0, 0, 0.2)";
    ...
    img.onerror = img.onabort = () => {
        ...
        cheat();
        let iframe = document.querySelector("iframe");
        iframe.contentWindow.alert("THANKS FOR SUPPORTING FRIXIUM")
    }
})();
